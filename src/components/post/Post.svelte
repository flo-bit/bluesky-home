	...
	<div class="flex gap-4">
		...
		<div class="w-full">
			...
			<div class="prose-base">
				<div
					class="prose dark:prose-invert prose-sm prose-a:no-underline prose-a:text-accent-600 dark:prose-a:text-accent-500 wrap-anywhere"
				>
					{#if data.htmlContent}
			...
			<div class="text-base-500 dark:text-base-400 mt-4 flex justify-end gap-6 px-4">
				...
				<button onclick={async () => {}} class="group items-center gap-2 text-sm hidden">
